...
def setTitle(str):
    system = platform.system()
    if system == 'Windows':
        ctypes.windll.kernel32.SetConsoleTitleW(f"{str} | Made By Vendetta#3517")
    else:
        os.system(f"\033]0;{str} | Made By Vendetta#3517\a")
...
def proxy_scrape():
    ...
    print(f"{Fore.YELLOW}Please wait while V-AN Scrapes proxies for you!")
